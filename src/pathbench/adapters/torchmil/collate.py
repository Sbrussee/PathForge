...
def torchmil_or_pathbench_collate(batch: list[Any], *, use_torchmil: bool = True) -> BagBatch:
    ...
    return pathbench_collate(bag_dicts)


def pathbench_collate(batch: list[BagBatch]) -> BagBatch:
