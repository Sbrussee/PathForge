...
class SklearnSlideTrainer(TrainerBase):
    """Fit a :class:`~pathforge.core.models.base.ScikitBase` estimator on
    ...
    :func:`~pathforge.training.metrics.save_task_evaluation_artifacts` pipeline
    used by :class:`~pathforge.training.lightning.LightningTrainer`.

    Args:
        output_dir: Root directory; model pickle and artifacts go here.
        task: PathForge task name — one of ``"classification"``,
