...
from pathforge.utils.optional.torchmil import is_torchsurv_available
...
def compute_task_metrics(
    ...
    *,
    ...
    """Compute scalar validation metrics for one PathForge task.
...
def _discrete_continuous_hazard_scores(
    ...
    *,
    ...
    For bin ``j = [t_j, t_{j+1})``, PathForge discrete survival heads model the
