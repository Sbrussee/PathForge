# src/pathforge/core/reports/tiles_report_pdf.py
...
def create_tiles_report_pdf(
    *,
    ...
    Args:
        dataset: PathForge WSIDataset (provides slide list/order and artifact paths).
...
def _draw_front_page(
    *,
    ...
    c.drawRightString(page_w - margin_x, title_y, "PathForge")
