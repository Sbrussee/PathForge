...
class Experiment:
    ...
    ``pathforge.core.experiments.combinations`` and dataset construction lives
    in ``pathforge.core.datasets.factory`` so this layer stays focused on
    ...
    def _determine_project_root(self) -> str:
        ...
        if project_root is not None:
            ...
            # Resolve repo root robustly (avoid cwd). Assumes repo layout: <repo>/src/pathforge/...
