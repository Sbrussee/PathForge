...
from pathforge.slide_retrieval.search_strategies.strategies.sish.sish_vqvae_descriptors import (
...
def main(argv: list[str] | None = None) -> int:
    """Argparse entry point for the SISH VQ-VAE CLI; returns a process exit code."""
    import argparse
