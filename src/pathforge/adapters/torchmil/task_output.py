...
def normalize_torchmil_output(output: Any, *, task: TaskName | str) -> torch.Tensor:
    """Normalize backend model outputs to PathForge loss contracts.
    ...
    Args:
        ...
        task: Current PathForge task. Classification expects logits shaped
    ...
    if task == "classification":
        ...
        # logit per bag. PathForge's classification losses/metrics expect
