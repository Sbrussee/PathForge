...
from pathforge.utils.optional.mil_lab import load_mil_lab_modules, require_mil_lab
...
def _canonicalize_mil_lab_kwargs(config_kwargs: dict[str, Any]) -> dict[str, Any]:
    """Map PathForge-style constructor kwargs onto MIL-Lab builder kwargs."""
...
def normalize_mil_lab_output(output: Any) -> torch.Tensor | dict[str, Any]:
    """Normalize MIL-Lab forward output to PathForge expectations."""
...
class MILLabBackendModel(MILModelBase):
    """Generic PathForge adapter for MIL-Lab MIL models."""
