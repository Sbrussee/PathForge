...
class SISHSearch(BaseSearchStrategy):
    ...
    Semantic goal:
        ...
        PathForge 2.0 search interfaces.
        ...
        **kwargs: Any,
        ...
        if self.return_patch_matches:
            raise NotImplementedError(
                "return_patch_matches=True is not supported in PathForge 2.0."
            )
    ...
    def _compute_patch_indices_from_mosaic(
        ...
        from pathforge.slide_retrieval.search_strategies.strategies.sish.sish_index import (
